...
void ver_1_initializer(void)
{
}

void ver_1_terminator(void)
{
}

/* SFunction Glue Code */
unsigned int sf_ver_1_method_dispatcher(SimStruct *simstructPtr, unsigned int
...
unsigned int sf_ver_1_process_check_sum_call( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(826550931U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1620425398U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3276551507U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3094434305U);
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2103420704U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2666618639U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(900956811U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1522771948U);
  }
...
unsigned int sf_ver_1_get_eml_resolved_functions_info( int nlhs, mxArray * plhs[],
     ...
     case 4:
      {
        if (strcmp(instanceChksum, "sKAF5f4WH4vMz91sVFoTNTE") == 0) {
          extern const mxArray *sf_c4_ver_1_get_eml_resolved_functions_info(void);
          mxArray *persistentMxArray = (mxArray *)
            sf_c4_ver_1_get_eml_resolved_functions_info();
...
unsigned int sf_ver_1_third_party_uses_info( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
     ...
     case 4:
      {
        if (strcmp(tpChksum, "sKAF5f4WH4vMz91sVFoTNTE") == 0) {
          extern mxArray *sf_c4_ver_1_third_party_uses_info(void);
          plhs[0] = sf_c4_ver_1_third_party_uses_info();
          break;
        }
      }
...
unsigned int sf_ver_1_jit_fallback_info( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
...
unsigned int sf_ver_1_get_post_codegen_info( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
     ...
     case 4:
      {
        if (strcmp(tpChksum, "sKAF5f4WH4vMz91sVFoTNTE") == 0) {
          ...
          const char* encoded_post_codegen_info =
            sf_c4_ver_1_get_post_codegen_info();
...
unsigned int sf_ver_1_updateBuildInfo_args_info( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
...
void ver_1_register_exported_symbols(SimStruct* S)
{
}
...
void unload_ver_1_optimization_info(void);
mxArray* load_ver_1_optimization_info(boolean_T isRtwGen, boolean_T isModelRef,
  boolean_T isExternal)
{
  ...
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info("ver_1", "ver_1");
