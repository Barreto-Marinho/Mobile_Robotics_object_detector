#ifndef __ver_1_sfun_h__
#define __ver_1_sfun_h__
...
extern mxArray* load_ver_1_optimization_info(boolean_T isRtwGen, boolean_T
  isModelRef, boolean_T isExternal);
extern void unload_ver_1_optimization_info(void);
