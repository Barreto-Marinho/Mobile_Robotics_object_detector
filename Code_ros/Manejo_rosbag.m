...
bag = rosbag('Rosbags/2021-10-13-16-35-42.bag');
...
msgsOdomrobot1 = readMessages(bagOdomrobot1,"DataFormat","struct");
bagOdomrobot2 = select(bag,"Topic",{ '/robot2/odom'});
msgsOdomrobot2 = readMessages(bagOdomrobot2,"DataFormat","struct");
bagrgbcam = select(bag,"Topic",{ '/robot1/camera/rgb/image_raw'});
msgsrgbcam = readMessages(bagrgbcam,"DataFormat","struct");
bagdepthcam = select(bag,"Topic",{ '/robot1/camera/depth/image_raw'});
msgsdepthcam  = readMessages(bagdepthcam,"DataFormat","struct");
